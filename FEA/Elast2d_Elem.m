function [ElemK, ElemF,fint,Dmat,GP,sigma] = Elast2d_Elem(mu1,mu2,kappa,xl,ul,nel,ndf,strain,stress,n) %changed inputs
%
...
% Body Force in the System : (if any)
Fb = zeros(2,1);


% Load Gauss Integration Points
