...
%Parameters for strain-energy function
mu1=100;
mu2=1000;
kappa=1000;
...
% Distribution of the Load on each of the nodal points 

LoadDist=[0.5;0.5];
tol=10^-10;             %tolerance used in N-R Method
Fext_app=1000;           %increments in which external load are applied
